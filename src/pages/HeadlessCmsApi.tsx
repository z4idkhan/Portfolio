      ...
      <div className="container mx-auto px-6 py-20 max-w-3xl">
        ...
        >
          ...
          <div className="glass-card rounded-xl p-6">
            <p className="text-sm text-muted-foreground mb-3 font-mono">API Endpoint (It Might Take 1 minute to reload as It has been deployed on Render on Free version)</p>
